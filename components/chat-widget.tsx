...
const SUGGESTIONS = [
  "What is DattaPay?",
  "How does it compare to Payoneer?",
  "What fees does DattaPay charge?",
  "How do I receive Upwork payments?",
];
  ...
  return (
    <>
          ...
          <div className="relative flex flex-col w-full h-full bg-background md:w-105 md:h-150 md:rounded-2xl md:border md:border-border md:shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-background">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-sm font-semibold">DattaPay Assistant</h2>
                  <p className="text-xs text-muted-foreground">
                    Ask anything about DattaPay
                  </p>
                </div>
              </div>
              ...
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Ask me about fees, features, or how DattaPay works.
                  </p>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 hover:scale-110 transition-all duration-300"
